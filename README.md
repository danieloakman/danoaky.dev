...
The [resume.pdf](./static/resume.pdf) file is captured/generated using Puppeteer. Puppeteer looks at the _/resume_ route, which can't be accessed in production.
